...
<%@page import="com.example.demo.bean.Service"%>
<%@page import="com.example.demo.bean.Client"%>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          if(user!=null){
	          %>
	          <li class="nav-item"><a href="#" class="nav-link"><%= user.getName() %></a></li>
	          <li class="nav-item"><a href="logout" class="nav-link">Logout</a></li>
	           <li class="nav-item"><a href="/showcart" class="nav-link">Your cart</a></li>
	          <%}else{ %>
    			...
    			<div class="col-md-12	featured-top">
    				<div class="row no-gutters">
	  					<div class="col-md-4 d-flex align-items-center">
	  						<form action="rent" class="request-form ftco-animate bg-primary">
		              ...
		              <div class="form-group">
		               ...
		               <%if(cart!=null) {%>
			            ...
			            <input type="hidden" name="image" value=<%=cart.getImage()%>>
    				...
    				%>
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						<h2 class="mb-0"><a href="#"><%=car.getName() %></a></h2>
		    						<div class="d-flex mb-3">
			    						<span class="cat"><%=car.getCat() %></span>
			    						<p class="price ml-auto">$<span><%=car.getPrice() %></span><span>/<%=car.getDay() %></span></p>
		    						</div>
		    						<p class="d-flex mb-0 d-block">
    						<%if(user!=null){ %>
    						<a href="cart?image=<%= car.getImage()%>&name=<%= car.getName()%>&cat=<%= car.getCat()%>&price=<%= car.getPrice()%>&day=<%= car.getDay()%>&u_id=<%=user.getEmail() %>" method="post" class="btn btn-primary py-2 mr-1">
    						<%}else{ %>
    						<a href="usernotfound"  class="btn btn-primary py-2 mr-1">
    						<%} %>
    						Book now</a> <a href="car" class="btn btn-secondary py-2 ml-1">Details</a></p>
		    					</div>
		    				</div>
    					</div>
    					<%} %>
		...
		<section class="ftco-section">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-3">Our Latest Services</h2>
				...
				<div class="row">
				<%List<Service> service=(List)session.getAttribute("Service");
				for(Service s:service){
				%>
					<div class="col-md-3">
						<div class="services services-2 w-100 text-center">
            	<div class="icon d-flex align-items-center justify-content-center"><span class="<%= s.getImage()%>"></span></div>
            	<div class="text w-100">
                <h3 class="heading mb-2"><%= s.getName() %></h3>
                <p><%= s.getDecp() %></p>
              </div>
            </div>
					</div>
      ...
      <div class="container">
        ...
        <div class="row ftco-animate">
          <div class="col-md-12">
            ...
            <%List<Client> client=(List)session.getAttribute("Client"); 
            for(Client c:client){
            %>
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5">
                  <div class="user-img mb-2" style="background-image: url(<%= c.getImage()%>)">
                  </div>
                  <div class="text pt-4">
                    <p class="mb-4"><%= c.getReview() %></p>
                    <p class="name"><%= c.getName() %></p>
                    <span class="position"><%= c.getProfession() %></span>
                  </div>
                </div>
              </div>
              <%} %>

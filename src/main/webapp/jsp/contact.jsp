      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-8 block-9 mb-md-5">
            <form action="/showcontact" class="bg-light p-5 contact-form">
              ...
              <div class="form-group">
                <textarea  id="" cols="30" rows="7" class="form-control" placeholder="Message" name="messege"></textarea>
              </div>
              <div class="form-group">
                <input type="submit" value="Send Message" class="btn btn-primary py-3 px-5">
              </div>
                <%String meet=(String)request.getAttribute("meet");
          if(meet!=null){
          %>
          <%=meet %>
          <%} %>
